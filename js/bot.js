(function() {
  ...
  function showCarrier() {
    botui.message.add({
      delay: 1500,
      content: "I received a master's degree in aerospace engineering. I proposed a new anormaly detection algorithm for spacecraft based on machine learning and orbital mechanics."
    }).then(function() {
      return botui.message.add({
        delay: 2500,
        content: 'After graduation, I worked as a industory researcher. I mainly focused on network engineering.'
      });
    }).then(function() {
      return botui.message.add({
        delay: 2500,
        content: 'The last year in the labs, I was seconded to another laborories located in USA. It was one of the most valuable experiences in my carrier.'
      });
    }).then(function() {
      return botui.message.add({
        delay: 2500,
        content: "Now I'm working as a data scientist at a marketing company in Japan."
      });
    }).then(askEnd);
  }
  ...
  function showHobby() {
    botui.message.add({
      ...
      return botui.message.add({
        delay: 2500,
        content: "I'm interested in Machine learning, Marketing science, and Network engineering" 
      });
    }).then(askEnd);
  }
